...
# DIAG 15: disable compile on optimizer steps
...
# Optimization
TOTAL_BATCH_SIZE = 2**13 # DIAG 15: small batch NaN test with uncompiled optimizer
...
# Model size
DEPTH = 2
DEVICE_BATCH_SIZE = 4   # DIAG 15: small batch (was 16)
