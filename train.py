...
# Optimization
TOTAL_BATCH_SIZE = 2**13 # ~8K tokens per optimizer step — testing bf16 bug
...
ADAM_BETAS = (0.7, 0.96)  # Adam beta1, beta2
...
DEVICE_BATCH_SIZE = 4   # per-device batch size (must fit in TOTAL_BATCH_SIZE)
